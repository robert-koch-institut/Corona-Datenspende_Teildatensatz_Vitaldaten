...
Eine maschinenlesbares Datenschema zu diesem Datensatz finden sie in der Datei [`frictionless_data_schema_Corona-Datenspende_Teildatensatz_Vitaldaten.json`](https://github.com/robert-koch-institut/Corona-Datenspende_Teildatensatz_Vitaldaten/blob/main/Metadaten/schemas/frictionless_data_schema_Corona-Datenspende_Teildatensatz_Vitaldaten.json).
